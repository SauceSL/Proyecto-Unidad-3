...
public class Cliente2 extends Application {
    ...
    private double playerTwoYPos = 200;
    ...
    private void handleKeyPress(KeyEvent event) {
        switch (event.getCode()) {
            case UP -> {
                playerTwoYPos = Math.max(playerTwoYPos - 10, 0);
                P2.setLayoutY(playerTwoYPos);
                sendMessage("POS P2 " + P2.getLayoutX() + " " + P2.getLayoutY());
            }
            case DOWN -> {
                playerTwoYPos = Math.min(playerTwoYPos + 10, 400);
                P2.setLayoutY(playerTwoYPos);
                sendMessage("POS P2 " + P2.getLayoutX() + " " + P2.getLayoutY());
            }
        }
